...
# Load Fashion MNIST20x20
_, test_loader, _, _ = load_mnist_dataset(batch_size=1, mnist20=True, fashion=True)

binarized_file_path = "pynq_notebooks/binarized_20x20_MNIST_Fashion.txt"
labels_file_path = "pynq_notebooks/mnist_fashion_test_labels.txt"
